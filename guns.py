...
class Gun2(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 2, 0), (32, 32)))
        super(Gun2, self).__init__('RoguelikeWeapons/Weapons 1-Sheet.png', rows=8, columns=25, column=2,
                                       width_image=70, damage=10, cooldown=0.5, bullet=image, max_columns=3)

class Gun3(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 3, 0), (32, 32)))
        super(Gun3, self).__init__('RoguelikeWeapons/Weapons 1-Sheet.png', rows=8, columns=25, column=3,
                                       width_image=70, damage=10, cooldown=0.5, bullet=image, max_columns=3)

class Gun4(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 4, 0), (32, 32)))
        super(Gun4, self).__init__('RoguelikeWeapons/Weapons 1-Sheet.png', rows=8, columns=25, column=4,
                                       width_image=70, damage=10, cooldown=0.5, bullet=image, max_columns=3)

class Gun5(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 5, 0), (32, 32)))
        super(Gun5, self).__init__('RoguelikeWeapons/Weapons 1-Sheet.png', rows=8, columns=25, column=5,
                                       width_image=70, damage=10, cooldown=0.5, bullet=image, max_columns=3)
class Gun6(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 6, 0), (32, 32)))
        super(Gun6, self).__init__('RoguelikeWeapons/Weapons 1-Sheet.png', rows=8, columns=25, column=6,
                                       width_image=70, damage=10, cooldown=0.5, bullet=image, max_columns=3)

class Gun7(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 7, 0), (32, 32)))
        super(Gun7, self).__init__('RoguelikeWeapons/Weapons 1-Sheet.png', rows=8, columns=25, column=7,
                                       width_image=70, damage=10, cooldown=0.5, bullet=image, max_columns=3)

class Gun8(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 8, 0), (32, 32)))
        super(Gun8, self).__init__('RoguelikeWeapons/Weapons 1-Sheet.png', rows=8, columns=25, column=8,
                                       width_image=70, damage=10, cooldown=0.5, bullet=image, max_columns=3)

class Gun9(Gun):
    def __init__(self):
        image = load_image('RoguelikeWeapons/Bullets 2-Sheet.png').subsurface(pygame.rect.Rect((32 * 9, 0), (32, 32)))
